...
#%% Reading CSV file
train = pd.read_csv('C:/Users/narxi/ml/02 - Logistic-Regression/titanic_train.csv')
...
fig = go.Figure(data=[{'type': 'histogram', 'x': train['Fare']}])
...
#%%
train.columns = ['Survived','Age','SibSp','Parch','Fare','Male','Queen Mary','Southampton','Second class','Third class']
